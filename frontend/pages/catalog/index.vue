  ...
  <div>
    ...
    <div class="mb-8">
      <div class="flex justify-between items-start mb-4">
        <div>
          <h1 class="text-3xl font-bold mb-2">Каталог товаров</h1>
          <p class="text-gray-600">Найдите именно то, что вам нужно</p>
        </div>
        <div class="flex space-x-3">
          <NuxtLink to="/categories" class="btn-secondary text-sm px-4 py-2">
            Все категории
          </NuxtLink>
          <NuxtLink to="/products" class="btn-secondary text-sm px-4 py-2">
            Все товары
          </NuxtLink>
        </div>
      </div>
...
// SEO
useHead({
  title: 'Каталог товаров - Nuxt Shop',
  meta: [
    { name: 'description', content: 'Каталог товаров интернет-магазина Nuxt Shop. Широкий ассортимент товаров по выгодным ценам.' }
  ]
})
